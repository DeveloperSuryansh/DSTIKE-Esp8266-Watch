...
const char D_INTRO_0[] PROGMEM = "Surya Deauther";
const char D_INTRO_1[] PROGMEM = "Credit @DeveloperSuryansh";
...
class DisplayUI {
    public:
        ...
        // ===== adjustable ===== //
#if defined(SSD1306_I2C)
        SSD1306Wire display = SSD1306Wire(I2C_ADDR, I2C_SCL, I2C_SDA);
#elif defined(SSD1306_SPI)
